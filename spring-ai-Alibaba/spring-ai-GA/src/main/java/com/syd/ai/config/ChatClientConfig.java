...
public class ChatClientConfig {
    ...
    public ChatClient planningChatClient(DeepSeekChatModel chatModel,  // 替换为DeepSeek模型
        ...
        return ChatClient.builder(chatModel)
                .defaultSystem("""
                        ...
                        用户若用户问“xxx的分数是多少”，必须使用工具getUserSource查询，参数为userName（用户姓名）
                         “严禁随意补全或猜测工具调用参数。
                ...
                .defaultToolCallbacks(mcpTools) // 绑定外部mcp tools
    ...
    public ChatClient botChatClient(DeepSeekChatModel chatModel,  // 替换为DeepSeek模型
        ...
        return ChatClient.builder(chatModel)
                .defaultSystem("""
                        你是XS航空智能客服代理， 请以友好的语气服务.用户若用户问“xxx的分数是多少”，必须使用工具getUserSource查询，参数为userName（用户姓名）。。
                         “严禁随意补全或猜测工具调用参数。
                         参数如缺失或语义不准，请不要补充或随意传递，请直接放弃本次工具调用。”
                         """)
                .defaultAdvisors(
